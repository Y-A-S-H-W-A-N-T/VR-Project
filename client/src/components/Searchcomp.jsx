  ...
  return (
    <div className="relative">
      <input
        ...
        onChange={''}
      />
      <button className="absolute inset-y-0 right-0 px-4 bg-amber-950 text-white font-semibold rounded-r-lg hover:bg-blue-600 focus:outline-none focus:bg-blue-600">
        Search
      </button>
    </div>
  );
