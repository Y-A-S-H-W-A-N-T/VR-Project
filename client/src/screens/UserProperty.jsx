            ...
            <div className="flex justify-center flex-row">
              {isAdmin === true || isAdmin === "true" ? (
                <div>
                  ...
                  >
                    Unverified
                    <FaBuildingCircleXmark className="ml-2 text-red-500 mt-1" />
                  </p>
                </div>
              ) : (
                <></>
              ...
              {showUpload && (
                <NotVerified toggleShowUpload={toggleShowUpload} />
              )}
              <div>
                {isAdmin === true || isAdmin === "true" ? (
                  <div onClick={() => setNotification(!notification)}>
                    <p className="m-1 text-amber-500 rounded-full p-2 flex">
                      <MdNotificationsActive size={36} />
                      {properties.length}
                    </p>
                  </div>
                ) : (
