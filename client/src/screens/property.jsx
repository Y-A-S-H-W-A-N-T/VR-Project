  ...
  return (
    ...
    <div className="flex flex-wrap items-center mb-4 font-extrabold">
      ...
      <div className="w-full md:w-auto md:flex-1">
        ...
        <button onClick={() => setShowRooms(!showRooms)} className="text-amber-50 hover:text-amber-100 border border-amber-700 hover:bg-amber-500 bg-amber-900  p-2 rounded-full  focus:outline-none w-2/3 h-1/3 mr-2">
